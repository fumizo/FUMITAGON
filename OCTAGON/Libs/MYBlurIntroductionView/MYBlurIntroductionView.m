...
-(void)initializeViewComponents{
    ...
    if ([MYIntroductionPanel runningiOS7]) {
        ...
        //FIXME:Massu Fixed
        /* sizeWithFont is deprecated iOS7
        ...
        */
        ...
        skipStringWidth = [skipString boundingRectWithSize:CGSizeMake(MAXFLOAT, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:kSkipButtonFont} context:nil].size.height;
    }
